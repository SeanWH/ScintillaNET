...
namespace ScintillaNET.EventArgs
{
    ...
    /// </summary>
    public class AutoCSelectionEventArgs : System.EventArgs
    {
        ...
        /// <remarks>Only a <see cref="ListCompletionMethod" /> of <see cref="ListCompletionMethod.FillUp" /> will return a non-zero character.</remarks>
        ...
        /// </summary>
        /// <returns>One of the <see cref="Enums.ListCompletionMethod" /> enumeration values.</returns>
